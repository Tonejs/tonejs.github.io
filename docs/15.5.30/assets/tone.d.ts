...
//   ../../../../../../../../../tmp/tmp-2388-MIorbunmSqKM/tslib
//   ../../../../../../../../../tmp/tmp-2388-MIorbunmSqKM/standardized-audio-context

declare module 'tone' {
    export * from "tone/classes.js";
    export { getContext, setContext } from "tone/core/Global.js";
    export * from "tone/version.js";
    import { ToneAudioBuffer } from "tone/core/context/ToneAudioBuffer.js";
    export { start } from "tone/core/Global.js";
    import { Seconds } from "tone/core/type/Units.js";
    export { supported } from "tone/core/context/AudioContext.js";
    import type { TransportInstance } from "tone/core/clock/Transport.js";
    export type { TransportInstance } from "tone/core/clock/Transport.js";
    import type { DestinationInstance } from "tone/core/context/Destination.js";
    export type { DestinationInstance } from "tone/core/context/Destination.js";
    import type { ListenerInstance } from "tone/core/context/Listener.js";
    export type { ListenerInstance } from "tone/core/context/Listener.js";
    import type { DrawInstance } from "tone/core/util/Draw.js";
    export type { DrawInstance } from "tone/core/util/Draw.js";
    /**
    ...
    /**
        ...
        */
    export const Transport: TransportInstance;
    /**
        * The Transport object belonging to the global Tone.js Context.
        * @see {@link TransportInstance}
        * @category Core
    ...
    /**
        ...
        */
    export const Destination: DestinationInstance;
    /**
        * @deprecated Use {@link getDestination} instead
        */
    export const Master: DestinationInstance;
    /**
        * The Destination (output) belonging to the global Tone.js Context.
        * @see {@link DestinationInstance}
        * @category Core
    ...
    /**
        ...
        */
    export const Listener: ListenerInstance;
    /**
        * The {@link ListenerInstance} belonging to the global Tone.js Context.
        * @category Core
        */
    ...
    /**
        ...
        */
    export const Draw: DrawInstance;
    /**
    ...
    /**
        ...
        */
    export const context: import("./classes.js").BaseContext;
    /**
    ...
    import { ToneAudioBuffers } from "tone/core/context/ToneAudioBuffers.js";
    import { ToneBufferSource } from "tone/source/buffer/ToneBufferSource.js";
...
export * from "tone/component/index.js";
export * from "tone/core/index.js";
export * from "tone/effect/index.js";
export * from "tone/event/index.js";
export * from "tone/instrument/index.js";
export * from "tone/signal/index.js";
export * from "tone/source/index.js";

import { version } from "tone/version.js";
import { theWindow } from "tone/core/context/AudioContext.js";
import { Context } from "tone/core/context/Context.js";
import { getContext, setContext as _setContext, } from "tone/core/context/GlobalContext.js";
import { OfflineContext } from "tone/core/context/OfflineContext.js";
import { isAudioContext, isOfflineAudioContext, } from "tone/core/util/AdvancedTypeCheck.js";
export { getContext };
/**
...
export const version = "15.5.30";

import { __awaiter } from "tslib";
import { Tone } from "tone/core/Tone.js";
import { assert } from "tone/core/util/Debug.js";
import { optionsFromArguments } from "tone/core/util/Defaults.js";
import { noOp } from "tone/core/util/Interface.js";
import { isArray, isNumber, isString } from "tone/core/util/TypeCheck.js";
import { getContext } from "tone/core/context/GlobalContext.js";
/**
...
export * from "tone/core/type/NoteUnits.js";
...
import { assert } from "tone/core/util/Debug.js";
import { isDefined } from "tone/core/util/TypeCheck.js";
/**
...
import { TimeClass } from "tone/core/type/Time.js";
import { TimelineValue } from "tone/core/util/TimelineValue.js";
import { Pow } from "tone/signal/Pow.js";
import { onContextClose, onContextInit, } from "tone/core/context/ContextInitialization.js";
import { Gain } from "tone/core/context/Gain.js";
import { ToneWithContext, } from "tone/core/context/ToneWithContext.js";
import { TicksClass } from "tone/core/type/Ticks.js";
import { TransportTimeClass } from "tone/core/type/TransportTime.js";
import { enterScheduledCallback } from "tone/core/util/Debug.js";
import { assertUsedScheduleTime } from "tone/core/util/Debug.js";
import { optionsFromArguments } from "tone/core/util/Defaults.js";
import { Emitter } from "tone/core/util/Emitter.js";
import { readOnly, writable } from "tone/core/util/Interface.js";
import { IntervalTimeline } from "tone/core/util/IntervalTimeline.js";
import { Timeline } from "tone/core/util/Timeline.js";
import { isArray, isDefined } from "tone/core/util/TypeCheck.js";
import { Clock } from "tone/core/clock/Clock.js";
import { TransportEvent } from "tone/core/clock/TransportEvent.js";
import { TransportRepeatEvent } from "tone/core/clock/TransportRepeatEvent.js";
/**
...
import { Volume } from "tone/component/channel/Volume.js";
import { optionsFromArguments } from "tone/core/util/Defaults.js";
import { onContextClose, onContextInit } from "tone/core/context/ContextInitialization.js";
import { Gain } from "tone/core/context/Gain.js";
import { connectSeries, ToneAudioNode, } from "tone/core/context/ToneAudioNode.js";
/**
...
import { onContextClose, onContextInit } from "tone/core/context/ContextInitialization.js";
import { Param } from "tone/core/context/Param.js";
...
import { optionsFromArguments } from "tone/core/util/Defaults.js";
import { noOp } from "tone/core/util/Interface.js";
import { isString } from "tone/core/util/TypeCheck.js";
import { ToneAudioBuffer } from "tone/core/context/ToneAudioBuffer.js";
/**
...
import { Param } from "tone/core/context/Param.js";
import { ToneAudioBuffer } from "tone/core/context/ToneAudioBuffer.js";
import { connect } from "tone/core/context/ToneAudioNode.js";
import { assert } from "tone/core/util/Debug.js";
import { defaultArg, optionsFromArguments } from "tone/core/util/Defaults.js";
import { noOp } from "tone/core/util/Interface.js";
import { EQ, GTE, LT } from "tone/core/util/Math.js";
import { isDefined } from "tone/core/util/TypeCheck.js";
import { OneShotSource, } from "tone/source/OneShotSource.js";
/**
...
export * from "tone/component/analysis/Analyser.js";
export * from "tone/component/analysis/DCMeter.js";
export * from "tone/component/analysis/FFT.js";
export * from "tone/component/analysis/Follower.js";
export * from "tone/component/analysis/Meter.js";
export * from "tone/component/analysis/Waveform.js";
export * from "tone/component/channel/Channel.js";
export * from "tone/component/channel/CrossFade.js";
export * from "tone/component/channel/Merge.js";
export * from "tone/component/channel/MidSideMerge.js";
export * from "tone/component/channel/MidSideSplit.js";
export * from "tone/component/channel/Mono.js";
export * from "tone/component/channel/MultibandSplit.js";
export * from "tone/component/channel/Panner.js";
export * from "tone/component/channel/Panner3D.js";
export * from "tone/component/channel/PanVol.js";
export * from "tone/component/channel/Recorder.js";
export * from "tone/component/channel/Solo.js";
export * from "tone/component/channel/Split.js";
export * from "tone/component/channel/Volume.js";
export * from "tone/component/dynamics/Compressor.js";
export * from "tone/component/dynamics/Gate.js";
export * from "tone/component/dynamics/Limiter.js";
export * from "tone/component/dynamics/MidSideCompressor.js";
export * from "tone/component/dynamics/MultibandCompressor.js";
export * from "tone/component/envelope/AmplitudeEnvelope.js";
export * from "tone/component/envelope/Envelope.js";
export * from "tone/component/envelope/FrequencyEnvelope.js";
export * from "tone/component/filter/BiquadFilter.js";
export * from "tone/component/filter/Convolver.js";
export * from "tone/component/filter/EQ3.js";
export * from "tone/component/filter/FeedbackCombFilter.js";
export * from "tone/component/filter/Filter.js";
export * from "tone/component/filter/LowpassCombFilter.js";
export * from "tone/component/filter/OnePoleFilter.js";

export * from "tone/core/clock/Clock.js";
export * from "tone/core/context/BaseContext.js";
export * from "tone/core/context/Context.js";
export * from "tone/core/context/Delay.js";
export * from "tone/core/context/Gain.js";
export * from "tone/core/context/Offline.js";
export * from "tone/core/context/OfflineContext.js";
export * from "tone/core/context/Param.js";
export * from "tone/core/context/ToneAudioBuffer.js";
export * from "tone/core/context/ToneAudioBuffers.js";
export * from "tone/core/context/ToneAudioNode.js";
export * from "tone/core/type/Frequency.js";
export * from "tone/core/type/Midi.js";
export * from "tone/core/type/Ticks.js";
export * from "tone/core/type/Time.js";
export * from "tone/core/type/TransportTime.js";
import "./util/Draw.js";
export { dbToGain, ftom, gainToDb, intervalToFrequencyRatio, mtof, } from "tone/core/type/Conversions.js";
export { defaultArg, optionsFromArguments } from "tone/core/util/Defaults.js";
export * from "tone/core/util/Emitter.js";
export * from "tone/core/util/IntervalTimeline.js";
export * from "tone/core/util/StateTimeline.js";
export * from "tone/core/util/Timeline.js";
export * from "tone/core/util/TypeCheck.js";
import * as Unit from "tone/core/type/Units.js";
export { Unit };
import * as debug from "tone/core/util/Debug.js";
/** @internal */
export { debug };

export * from "tone/effect/AutoFilter.js";
export * from "tone/effect/AutoPanner.js";
export * from "tone/effect/AutoWah.js";
export * from "tone/effect/BitCrusher.js";
export * from "tone/effect/Chebyshev.js";
export * from "tone/effect/Chorus.js";
export * from "tone/effect/Distortion.js";
export * from "tone/effect/FeedbackDelay.js";
export * from "tone/effect/Freeverb.js";
export * from "tone/effect/FrequencyShifter.js";
export * from "tone/effect/JCReverb.js";
export * from "tone/effect/Phaser.js";
export * from "tone/effect/PingPongDelay.js";
export * from "tone/effect/PitchShift.js";
export * from "tone/effect/Reverb.js";
export * from "tone/effect/ReverseDelay.js";
export * from "tone/effect/StereoWidener.js";
export * from "tone/effect/Tremolo.js";
export * from "tone/effect/Vibrato.js";

export * from "tone/event/Loop.js";
export * from "tone/event/Part.js";
export * from "tone/event/Pattern.js";
export * from "tone/event/Sequence.js";
export * from "tone/event/ToneEvent.js";

export * from "tone/instrument/AMSynth.js";
export * from "tone/instrument/DuoSynth.js";
export * from "tone/instrument/FMSynth.js";
export * from "tone/instrument/MembraneSynth.js";
export * from "tone/instrument/MetalSynth.js";
export * from "tone/instrument/MonoSynth.js";
export * from "tone/instrument/NoiseSynth.js";
export * from "tone/instrument/PluckSynth.js";
export * from "tone/instrument/PolySynth.js";
export * from "tone/instrument/Sampler.js";
export * from "tone/instrument/Synth.js";

export * from "tone/signal/Abs.js";
export * from "tone/signal/Add.js";
export * from "tone/signal/AudioToGain.js";
export * from "tone/signal/GainToAudio.js";
export * from "tone/signal/GreaterThan.js";
export * from "tone/signal/GreaterThanZero.js";
export * from "tone/signal/Multiply.js";
export * from "tone/signal/Negate.js";
export * from "tone/signal/Pow.js";
export * from "tone/signal/Scale.js";
export * from "tone/signal/ScaleExp.js";
export * from "tone/signal/Signal.js";
export * from "tone/signal/Subtract.js";
export * from "tone/signal/SyncedSignal.js";
export * from "tone/signal/WaveShaper.js";
export * from "tone/signal/Zero.js";

export * from "tone/source/buffer/GrainPlayer.js";
export * from "tone/source/buffer/Player.js";
export * from "tone/source/buffer/Players.js";
export * from "tone/source/buffer/ToneBufferSource.js";
export * from "tone/source/Noise.js";
export * from "tone/source/oscillator/AMOscillator.js";
export * from "tone/source/oscillator/FatOscillator.js";
export * from "tone/source/oscillator/FMOscillator.js";
export * from "tone/source/oscillator/LFO.js";
export * from "tone/source/oscillator/OmniOscillator.js";
export * from "tone/source/oscillator/Oscillator.js";
export * from "tone/source/oscillator/PulseOscillator.js";
export * from "tone/source/oscillator/PWMOscillator.js";
export * from "tone/source/oscillator/ToneOscillatorNode.js";
export * from "tone/source/UserMedia.js";

import { __awaiter } from "tslib";
import { Ticker } from "tone/core/clock/Ticker.js";
import { isAudioContext } from "tone/core/util/AdvancedTypeCheck.js";
import { assert } from "tone/core/util/Debug.js";
import { optionsFromArguments } from "tone/core/util/Defaults.js";
import { Timeline } from "tone/core/util/Timeline.js";
import { isDefined } from "tone/core/util/TypeCheck.js";
import { createAudioContext, createAudioWorkletNode, } from "tone/core/context/AudioContext.js";
import { BaseContext } from "tone/core/context/BaseContext.js";
import { closeContext, initializeContext } from "tone/core/context/ContextInitialization.js";
/**
...
import { hasAudioContext } from "tone/core/context/AudioContext.js";
import { Context } from "tone/core/context/Context.js";
import { DummyContext } from "tone/core/context/DummyContext.js";
/**
...
import { __awaiter } from "tslib";
import { createOfflineAudioContext } from "tone/core/context/AudioContext.js";
import { Context } from "tone/core/context/Context.js";
import { isOfflineAudioContext } from "tone/core/util/AdvancedTypeCheck.js";
import { getContext, setContext } from "tone/core/context/GlobalContext.js";
import { ToneAudioBuffer } from "tone/core/context/ToneAudioBuffer.js";
/**
...
import { version } from "tone/version.js";
import { theWindow } from "tone/core/context/AudioContext.js";
import { log } from "tone/core/util/Debug.js";
/**
...
import { isUndef } from "tone/core/util/TypeCheck.js";
/**
...
import { isAudioBuffer, isAudioNode, isAudioParam, } from "tone/core/util/AdvancedTypeCheck.js";
import { isDefined, isObject, isUndef } from "tone/core/util/TypeCheck.js";
/**
...
import { isArray } from "tone/core/util/TypeCheck.js";
/**
...
import { ftom } from "tone/core/type/Conversions.js";
import { TimeBaseClass, } from "tone/core/type/TimeBase.js";
/**
...
import { optionsFromArguments } from "tone/core/util/Defaults.js";
import { SignalOperator } from "tone/signal/SignalOperator.js";
import { WaveShaper } from "tone/signal/WaveShaper.js";
/**
...
import { Param } from "tone/core/context/Param.js";
import { optionsFromArguments } from "tone/core/util/Defaults.js";
import { readOnly } from "tone/core/util/Interface.js";
import { ToneAudioNode } from "tone/core/context/ToneAudioNode.js";
/**
...
import { getContext } from "tone/core/Global.js";
import { Tone } from "tone/core/Tone.js";
import { FrequencyClass } from "tone/core/type/Frequency.js";
import { TimeClass } from "tone/core/type/Time.js";
import { TransportTimeClass } from "tone/core/type/TransportTime.js";
import { assertUsedScheduleTime } from "tone/core/util/Debug.js";
import { getDefaultsFromInstance, optionsFromArguments, } from "tone/core/util/Defaults.js";
import { isArray, isBoolean, isDefined, isNumber, isString, isUndef, } from "tone/core/util/TypeCheck.js";
import { onContextRunning } from "tone/core/context/OnRunning.js";
/**
...
import { assert } from "tone/core/util/Debug.js";
import { optionsFromArguments } from "tone/core/util/Defaults.js";
import { EQ, GT, GTE, LT } from "tone/core/util/Math.js";
/**
...
import { ToneWithContext, } from "tone/core/context/ToneWithContext.js";
import { assertContextRunning } from "tone/core/util/Debug.js";
import { optionsFromArguments } from "tone/core/util/Defaults.js";
import { Emitter } from "tone/core/util/Emitter.js";
import { noOp, readOnly } from "tone/core/util/Interface.js";
import { StateTimeline } from "tone/core/util/StateTimeline.js";
import { TickSource } from "tone/core/clock/TickSource.js";
/**
...
import { TicksClass } from "tone/core/type/Ticks.js";
import { GT, LT } from "tone/core/util/Math.js";
import { TransportEvent } from "tone/core/clock/TransportEvent.js";
/**
...
import { isAudioNode, isAudioParam } from "tone/core/util/AdvancedTypeCheck.js";
import { assert, warn } from "tone/core/util/Debug.js";
import { isDefined } from "tone/core/util/TypeCheck.js";
import { Param } from "tone/core/context/Param.js";
import { ToneWithContext } from "tone/core/context/ToneWithContext.js";
/**
...
import { dbToGain, gainToDb } from "tone/core/type/Conversions.js";
import { isAudioParam } from "tone/core/util/AdvancedTypeCheck.js";
import { assert, assertRange } from "tone/core/util/Debug.js";
import { optionsFromArguments } from "tone/core/util/Defaults.js";
import { EQ } from "tone/core/util/Math.js";
import { Timeline } from "tone/core/util/Timeline.js";
import { isDefined } from "tone/core/util/TypeCheck.js";
import { ToneWithContext } from "tone/core/context/ToneWithContext.js";
/**
...
import { assert, assertRange } from "tone/core/util/Debug.js";
import { optionsFromArguments } from "tone/core/util/Defaults.js";
import { Split } from "tone/component/channel/Split.js";
/**
...
import { optionsFromArguments } from "tone/core/util/Defaults.js";
import { MeterBase } from "tone/component/analysis/MeterBase.js";
/**
...
import { ToneAudioNode } from "tone/core/context/ToneAudioNode.js";
import { dbToGain } from "tone/core/type/Conversions.js";
import { assert } from "tone/core/util/Debug.js";
import { optionsFromArguments } from "tone/core/util/Defaults.js";
import { MeterBase } from "tone/component/analysis/MeterBase.js";
/**
...
import { ToneAudioNode, } from "tone/core/context/ToneAudioNode.js";
import { optionsFromArguments } from "tone/core/util/Defaults.js";
import { Abs } from "tone/signal/Abs.js";
import { OnePoleFilter } from "tone/component/filter/OnePoleFilter.js";
/**
...
import { dbToGain, gainToDb } from "tone/core/type/Conversions.js";
import { warn } from "tone/core/util/Debug.js";
import { optionsFromArguments } from "tone/core/util/Defaults.js";
import { Analyser } from "tone/component/analysis/Analyser.js";
import { MeterBase } from "tone/component/analysis/MeterBase.js";
/**
...
import { optionsFromArguments } from "tone/core/util/Defaults.js";
import { readOnly } from "tone/core/util/Interface.js";
import { PanVol } from "tone/component/channel/PanVol.js";
import { Solo } from "tone/component/channel/Solo.js";
/**
...
import { Gain } from "tone/core/context/Gain.js";
import { connect, ToneAudioNode, } from "tone/core/context/ToneAudioNode.js";
import { optionsFromArguments } from "tone/core/util/Defaults.js";
import { readOnly } from "tone/core/util/Interface.js";
import { GainToAudio } from "tone/signal/GainToAudio.js";
import { Signal } from "tone/signal/Signal.js";
import { ToneConstantSource } from "tone/signal/ToneConstantSource.js";
/**
...
import { ToneAudioNode, } from "tone/core/context/ToneAudioNode.js";
import { optionsFromArguments } from "tone/core/util/Defaults.js";
import { Add } from "tone/signal/Add.js";
import { Multiply } from "tone/signal/Multiply.js";
import { Subtract } from "tone/signal/Subtract.js";
...
import { readOnly, writable } from "tone/core/util/Interface.js";
import { Signal } from "tone/signal/Signal.js";
import { Filter } from "tone/component/filter/Filter.js";
/**
...
import { optionsFromArguments } from "tone/core/util/Defaults.js";
import { readOnly } from "tone/core/util/Interface.js";
import { Panner } from "tone/component/channel/Panner.js";
import { Volume } from "tone/component/channel/Volume.js";
/**
...
import { dbToGain, gainToDb } from "tone/core/type/Conversions.js";
import { optionsFromArguments } from "tone/core/util/Defaults.js";
import { GreaterThan } from "tone/signal/GreaterThan.js";
import { Follower } from "tone/component/analysis/Follower.js";
/**
...
import { optionsFromArguments } from "tone/core/util/Defaults.js";
import { readOnly } from "tone/core/util/Interface.js";
import { Compressor } from "tone/component/dynamics/Compressor.js";
/**
...
import { optionsFromArguments } from "tone/core/util/Defaults.js";
import { readOnly } from "tone/core/util/Interface.js";
import { MidSideMerge } from "tone/component/channel/MidSideMerge.js";
import { MidSideSplit } from "tone/component/channel/MidSideSplit.js";
import { Compressor } from "tone/component/dynamics/Compressor.js";
/**
...
import { optionsFromArguments } from "tone/core/util/Defaults.js";
import { readOnly } from "tone/core/util/Interface.js";
import { MultibandSplit } from "tone/component/channel/MultibandSplit.js";
import { Compressor } from "tone/component/dynamics/Compressor.js";
/**
...
import { Gain } from "tone/core/context/Gain.js";
import { optionsFromArguments } from "tone/core/util/Defaults.js";
import { Envelope } from "tone/component/envelope/Envelope.js";
/**
...
import { ToneAudioNode, } from "tone/core/context/ToneAudioNode.js";
import { assert } from "tone/core/util/Debug.js";
import { range, timeRange } from "tone/core/util/Decorator.js";
import { optionsFromArguments } from "tone/core/util/Defaults.js";
import { isArray, isObject, isString } from "tone/core/util/TypeCheck.js";
import { connectSignal, disconnectSignal, Signal, } from "tone/signal/Signal.js";
/**
...
import { assertRange } from "tone/core/util/Debug.js";
import { optionsFromArguments } from "tone/core/util/Defaults.js";
import { Pow } from "tone/signal/Pow.js";
import { Scale } from "tone/signal/Scale.js";
import { Envelope } from "tone/component/envelope/Envelope.js";
/**
...
import { optionsFromArguments } from "tone/core/util/Defaults.js";
import { readOnly } from "tone/core/util/Interface.js";
import { ToneAudioWorklet } from "tone/core/worklet/ToneAudioWorklet.js";
import { workletName } from "tone/component/filter/FeedbackCombFilter.worklet.js";
/**
...
import { optionsFromArguments } from "tone/core/util/Defaults.js";
import { readOnly, writable } from "tone/core/util/Interface.js";
import { isNumber } from "tone/core/util/TypeCheck.js";
import { Signal } from "tone/signal/Signal.js";
import { BiquadFilter } from "tone/component/filter/BiquadFilter.js";
/**
...
import { ToneAudioNode, } from "tone/core/context/ToneAudioNode.js";
import { optionsFromArguments } from "tone/core/util/Defaults.js";
import { FeedbackCombFilter } from "tone/component/filter/FeedbackCombFilter.js";
import { OnePoleFilter } from "tone/component/filter/OnePoleFilter.js";
/**
...
import { getContext } from "tone/core/Global.js";
import { intervalToFrequencyRatio, mtof } from "tone/core/type/Conversions.js";
import { ftom, getA4, setA4 } from "tone/core/type/Conversions.js";
import { TimeClass } from "tone/core/type/Time.js";
/**
...
import { getContext } from "tone/core/Global.js";
import { ftom, mtof } from "tone/core/type/Conversions.js";
import { FrequencyClass } from "tone/core/type/Frequency.js";
/**
...
import { Filter } from "tone/component/filter/Filter.js";
import { optionsFromArguments } from "tone/core/util/Defaults.js";
import { LFOEffect } from "tone/effect/LFOEffect.js";
/**
...
import { optionsFromArguments } from "tone/core/util/Defaults.js";
import { readOnly } from "tone/core/util/Interface.js";
import { ScaleExp } from "tone/signal/ScaleExp.js";
import { Effect } from "tone/effect/Effect.js";
/**
...
import { Gain } from "tone/core/context/Gain.js";
import { Param } from "tone/core/context/Param.js";
import { connectSeries } from "tone/core/context/ToneAudioNode.js";
import { optionsFromArguments } from "tone/core/util/Defaults.js";
import { ToneAudioWorklet, } from "tone/core/worklet/ToneAudioWorklet.js";
import { workletName } from "tone/effect/BitCrusher.worklet.js";
import { Effect } from "tone/effect/Effect.js";
/**
...
import { Delay } from "tone/core/context/Delay.js";
import { optionsFromArguments } from "tone/core/util/Defaults.js";
import { readOnly } from "tone/core/util/Interface.js";
import { StereoFeedbackEffect, } from "tone/effect/StereoFeedbackEffect.js";
import { LFO } from "tone/source/oscillator/LFO.js";
/**
...
import { optionsFromArguments } from "tone/core/util/Defaults.js";
import { readOnly } from "tone/core/util/Interface.js";
import { FeedbackEffect } from "tone/effect/FeedbackEffect.js";
/**
...
import { LowpassCombFilter } from "tone/component/filter/LowpassCombFilter.js";
import { optionsFromArguments } from "tone/core/util/Defaults.js";
import { readOnly } from "tone/core/util/Interface.js";
import { Signal } from "tone/signal/Signal.js";
import { StereoEffect } from "tone/effect/StereoEffect.js";
/**
...
import { PhaseShiftAllpass } from "tone/component/filter/PhaseShiftAllpass.js";
import { optionsFromArguments } from "tone/core/util/Defaults.js";
import { Effect } from "tone/effect/Effect.js";
import { Add } from "tone/signal/Add.js";
import { Multiply } from "tone/signal/Multiply.js";
import { Negate } from "tone/signal/Negate.js";
import { Signal } from "tone/signal/Signal.js";
import { Oscillator } from "tone/source/oscillator/Oscillator.js";
import { ToneOscillatorNode } from "tone/source/oscillator/ToneOscillatorNode.js";
/**
...
import { readOnly } from "tone/core/util/Interface.js";
import { Signal } from "tone/signal/Signal.js";
import { LFOStereoEffect } from "tone/effect/LFOStereoEffect.js";
/**
...
import { readOnly } from "tone/core/util/Interface.js";
import { Signal } from "tone/signal/Signal.js";
import { StereoXFeedbackEffect, } from "tone/effect/StereoXFeedbackEffect.js";
/**
...
import { CrossFade } from "tone/component/channel/CrossFade.js";
import { Delay } from "tone/core/context/Delay.js";
import { intervalToFrequencyRatio } from "tone/core/type/Conversions.js";
import { optionsFromArguments } from "tone/core/util/Defaults.js";
import { readOnly } from "tone/core/util/Interface.js";
import { Signal } from "tone/signal/Signal.js";
import { LFO } from "tone/source/oscillator/LFO.js";
...
import { optionsFromArguments } from "tone/core/util/Defaults.js";
import { noOp } from "tone/core/util/Interface.js";
import { Noise } from "tone/source/Noise.js";
import { Effect } from "tone/effect/Effect.js";
/**
...
import { ToneAudioWorklet, } from "tone/core/worklet/ToneAudioWorklet.js";
import { Effect } from "tone/effect/Effect.js";
import { workletName } from "tone/effect/ReverseDelay.worklet.js";
/**
...
import { optionsFromArguments } from "tone/core/util/Defaults.js";
import { readOnly } from "tone/core/util/Interface.js";
import { MidSideEffect, } from "tone/effect/MidSideEffect.js";
import { Multiply } from "tone/signal/Multiply.js";
import { Signal } from "tone/signal/Signal.js";
import { Subtract } from "tone/signal/Subtract.js";
import { ToneConstantSource } from "tone/signal/ToneConstantSource.js";
...
import { optionsFromArguments } from "tone/core/util/Defaults.js";
import { noOp } from "tone/core/util/Interface.js";
import { ToneEvent } from "tone/event/ToneEvent.js";
/**
...
import { defaultArg, optionsFromArguments } from "tone/core/util/Defaults.js";
import { StateTimeline } from "tone/core/util/StateTimeline.js";
import { isArray, isDefined, isObject, isUndef, } from "tone/core/util/TypeCheck.js";
import { ToneEvent } from "tone/event/ToneEvent.js";
/**
...
import { optionsFromArguments } from "tone/core/util/Defaults.js";
import { noOp } from "tone/core/util/Interface.js";
import { Loop } from "tone/event/Loop.js";
import { PatternGenerator } from "tone/event/PatternGenerator.js";
/**
...
import { TicksClass } from "tone/core/type/Ticks.js";
import { omitFromObject, optionsFromArguments } from "tone/core/util/Defaults.js";
import { isArray, isString } from "tone/core/util/TypeCheck.js";
import { Part } from "tone/event/Part.js";
import { ToneEvent } from "tone/event/ToneEvent.js";
/**
...
import { noOp } from "tone/core/util/Interface.js";
import { StateTimeline, } from "tone/core/util/StateTimeline.js";
import { isBoolean, isNumber } from "tone/core/util/TypeCheck.js";
/**
...
import { optionsFromArguments } from "tone/core/util/Defaults.js";
import { AudioToGain } from "tone/signal/AudioToGain.js";
import { ModulationSynth } from "tone/instrument/ModulationSynth.js";
/**
...
import { Gain } from "tone/core/context/Gain.js";
import { deepMerge, omitFromObject, optionsFromArguments, } from "tone/core/util/Defaults.js";
import { readOnly } from "tone/core/util/Interface.js";
import { Multiply } from "tone/signal/Multiply.js";
import { Signal } from "tone/signal/Signal.js";
import { LFO } from "tone/source/oscillator/LFO.js";
import { Monophonic } from "tone/instrument/Monophonic.js";
import { MonoSynth } from "tone/instrument/MonoSynth.js";
/**
...
import { FrequencyClass } from "tone/core/type/Frequency.js";
import { range, timeRange } from "tone/core/util/Decorator.js";
import { deepMerge, optionsFromArguments } from "tone/core/util/Defaults.js";
import { readOnly } from "tone/core/util/Interface.js";
import { Monophonic } from "tone/instrument/Monophonic.js";
import { Synth } from "tone/instrument/Synth.js";
/**
...
import { Scale } from "tone/signal/Scale.js";
import { Signal } from "tone/signal/Signal.js";
import { FMOscillator } from "tone/source/oscillator/FMOscillator.js";
import { Monophonic } from "tone/instrument/Monophonic.js";
/**
...
import { AmplitudeEnvelope } from "tone/component/envelope/AmplitudeEnvelope.js";
import { Envelope } from "tone/component/envelope/Envelope.js";
import { FrequencyEnvelope, } from "tone/component/envelope/FrequencyEnvelope.js";
import { Filter } from "tone/component/filter/Filter.js";
import { ToneAudioNode, } from "tone/core/context/ToneAudioNode.js";
import { omitFromObject, optionsFromArguments } from "tone/core/util/Defaults.js";
import { readOnly } from "tone/core/util/Interface.js";
import { Monophonic } from "tone/instrument/Monophonic.js";
import { OmniOscillator } from "tone/source/oscillator/OmniOscillator.js";
import { Source } from "tone/source/Source.js";
/**
...
import { LowpassCombFilter } from "tone/component/filter/LowpassCombFilter.js";
import { deepMerge } from "tone/core/util/Defaults.js";
import { optionsFromArguments } from "tone/core/util/Defaults.js";
import { Noise } from "tone/source/Noise.js";
import { Instrument } from "tone/instrument/Instrument.js";
/**
...
import { MidiClass } from "tone/core/type/Midi.js";
import { assert, warn } from "tone/core/util/Debug.js";
import { deepMerge, omitFromObject, optionsFromArguments, } from "tone/core/util/Defaults.js";
import { isArray, isNumber } from "tone/core/util/TypeCheck.js";
import { Instrument } from "tone/instrument/Instrument.js";
import { Monophonic } from "tone/instrument/Monophonic.js";
import { Synth } from "tone/instrument/Synth.js";
/**
...
import { __decorate } from "tslib";
import { ToneAudioBuffers } from "tone/core/context/ToneAudioBuffers.js";
import { ftomf, intervalToFrequencyRatio } from "tone/core/type/Conversions.js";
import { FrequencyClass } from "tone/core/type/Frequency.js";
import { assert, assertRange } from "tone/core/util/Debug.js";
import { timeRange } from "tone/core/util/Decorator.js";
import { defaultArg, optionsFromArguments } from "tone/core/util/Defaults.js";
import { noOp } from "tone/core/util/Interface.js";
import { isArray, isNote, isNumber } from "tone/core/util/TypeCheck.js";
import { Instrument } from "tone/instrument/Instrument.js";
import { ToneBufferSource, } from "tone/source/buffer/ToneBufferSource.js";
/**
...
import { optionsFromArguments } from "tone/core/util/Defaults.js";
import { readOnly } from "tone/core/util/Interface.js";
import { GreaterThanZero } from "tone/signal/GreaterThanZero.js";
import { Signal } from "tone/signal/Signal.js";
import { Subtract } from "tone/signal/Subtract.js";
/**
...
import { Param } from "tone/core/context/Param.js";
import { disconnect, ToneAudioNode, } from "tone/core/context/ToneAudioNode.js";
import { connect } from "tone/core/context/ToneAudioNode.js";
import { isAudioParam } from "tone/core/util/AdvancedTypeCheck.js";
import { optionsFromArguments } from "tone/core/util/Defaults.js";
import { isUndef } from "tone/core/util/TypeCheck.js";
...
import { __awaiter, __decorate } from "tslib";
import { TickParam } from "tone/core/clock/TickParam.js";
import { ToneAudioBuffer } from "tone/core/context/ToneAudioBuffer.js";
import { assertRange } from "tone/core/util/Debug.js";
import { timeRange } from "tone/core/util/Decorator.js";
import { defaultArg, optionsFromArguments } from "tone/core/util/Defaults.js";
...
import { noOp, readOnly } from "tone/core/util/Interface.js";
import { Source } from "tone/source/Source.js";
import { Player } from "tone/source/buffer/Player.js";
/**
...
import { Source } from "tone/source/Source.js";
import { Oscillator } from "tone/source/oscillator/Oscillator.js";
import { generateWaveform, } from "tone/source/oscillator/OscillatorInterface.js";
/**
...
import { Scale } from "tone/signal/Scale.js";
import { connectSignal, disconnectSignal, Signal, } from "tone/signal/Signal.js";
import { Zero } from "tone/signal/Zero.js";
import { Oscillator } from "tone/source/oscillator/Oscillator.js";
/**
...
import { optionsFromArguments } from "tone/core/util/Defaults.js";
import { readOnly } from "tone/core/util/Interface.js";
import { isNumber, isString } from "tone/core/util/TypeCheck.js";
import { Signal } from "tone/signal/Signal.js";
import { Source } from "tone/source/Source.js";
import { AMOscillator } from "tone/source/oscillator/AMOscillator.js";
import { FatOscillator } from "tone/source/oscillator/FatOscillator.js";
import { FMOscillator } from "tone/source/oscillator/FMOscillator.js";
import { Oscillator } from "tone/source/oscillator/Oscillator.js";
import { generateWaveform, } from "tone/source/oscillator/OscillatorInterface.js";
import { PulseOscillator } from "tone/source/oscillator/PulseOscillator.js";
import { PWMOscillator } from "tone/source/oscillator/PWMOscillator.js";
...
import { __awaiter } from "tslib";
import { assertRange } from "tone/core/util/Debug.js";
import { deepEquals, optionsFromArguments } from "tone/core/util/Defaults.js";
import { readOnly } from "tone/core/util/Interface.js";
import { clamp } from "tone/core/util/Math.js";
import { isDefined } from "tone/core/util/TypeCheck.js";
import { Signal } from "tone/signal/Signal.js";
import { Source } from "tone/source/Source.js";
import { generateWaveform, } from "tone/source/oscillator/OscillatorInterface.js";
...
import { deepMerge, optionsFromArguments } from "tone/core/util/Defaults.js";
import { readOnly } from "tone/core/util/Interface.js";
import { isDefined, isNumber, isObject } from "tone/core/util/TypeCheck.js";
/**
...
import { Tone } from "tone/core/Tone.js";
import { isDefined, isObject, isString, isUndef } from "tone/core/util/TypeCheck.js";
/**
...
import { ToneAudioNode, } from "tone/core/context/ToneAudioNode.js";
import { optionsFromArguments } from "tone/core/util/Defaults.js";
import { connectSignal, disconnectSignal } from "tone/signal/Signal.js";
/**
...
import { Timeline } from "tone/core/util/Timeline.js";
import { isDefined } from "tone/core/util/TypeCheck.js";
import { TickSignal } from "tone/core/clock/TickSignal.js";
/**
...
import { ToneAudioNode, } from "tone/core/context/ToneAudioNode.js";
import { noOp } from "tone/core/util/Interface.js";
import { getWorkletGlobalScope } from "tone/core/worklet/WorkletGlobalScope.js";
...
import { registerProcessor } from "tone/core/worklet/WorkletGlobalScope.js";
...
import { Split } from "tone/component/channel/Split.js";
import { Gain } from "tone/core/context/Gain.js";
import { connect, connectSeries, ToneAudioNode, } from "tone/core/context/ToneAudioNode.js";
import { readOnly } from "tone/core/util/Interface.js";
/**
...
import { Volume } from "tone/component/channel/Volume.js";
import { ToneAudioNode, } from "tone/core/context/ToneAudioNode.js";
import { assert, assertContextRunning } from "tone/core/util/Debug.js";
import { defaultArg } from "tone/core/util/Defaults.js";
import { noOp, readOnly } from "tone/core/util/Interface.js";
import { GT } from "tone/core/util/Math.js";
import { StateTimeline, } from "tone/core/util/StateTimeline.js";
import { isDefined, isUndef } from "tone/core/util/TypeCheck.js";
/**
