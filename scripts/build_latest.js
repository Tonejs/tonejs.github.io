...
copySync(resolve(__dirname, '../node_modules/tone/build/Tone.js'), resolve(DOCS_DIR, latest, 'assets/js/Tone.js'))
copySync(resolve(__dirname, '../node_modules/@tonejs/plot/dist/index.js'), resolve(DOCS_DIR, latest, 'assets/js/Plot.js'))